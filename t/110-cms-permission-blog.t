...
subtest 'mode = rebuild_new_phase' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_new_phase" );
    ok( $out !~ m!permission=1!i, "rebuild_new_phase by permitted user (publish_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_new_phase" );
    ok( $out !~ m!permission=1!i, "rebuild_new_phase by permitted user (edit_all_posts)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_new_phase" );
    ok( $out !~ m!permission=1!i, "rebuild_new_phase by permitted user (manage pages)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_new_phase" );
    ok( $out =~ m!permission=1!i, "rebuild_new_phase by other blog (edit_all_posts)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_new_phase" );
    ok( $out =~ m!permission=1!i, "rebuild_new_phase by other blog (publish_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: rebuild_new_phase" );
    ok( $out =~ m!permission=1!i, "rebuild_new_phase by other blog (manage pages)" );
...
subtest 'mode = start_rebuild' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!permission=1!i, "start_rebuild by permitted user (rebuild)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!permission=1!i, "start_rebuild by permitted user (edit_all_posts)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!permission=1!i, "start_rebuild by permitted user (manage_pages)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!permission=1!i, "start_rebuild by permitted user (publish_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out !~ m!permission=1!i, "start_rebuild by permitted user (manage_feedback)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!permission=1!i, "start_rebuild by other blog (edit_all_posts)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!permission=1!i, "start_rebuild by other blog (manage_pages)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!permission=1!i, "start_rebuild by other blog (publish_post)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: start_rebuild" );
    ok( $out =~ m!permission=1!i, "start_rebuild by other blog (manage_feedback)" );
...
subtest 'mode = update_welcome_message' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: update_welcome_message" );
    ok( $out !~ m!permission=1!i, "update_welcome_message by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: update_welcome_message" );
    ok( $out =~ m!permission=1!i, "update_welcome_message by other permission" );
    done_testing();
};
...
subtest 'mode = save (edit)' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save" );
    ok( $out !~ m!permission=1!i, "save (edit) by permitted user (blog admin)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: save" );
    ok( $out =~ m!permission=1!i, "save (edit) by non permitted user (create blog)" );
...
subtest 'mode = edit (edit)' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: edit" );
    ok( $out !~ m!Permission=1!i, "edit (edit) by permitted user (blog admin)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: edit" );
    ok( $out =~ m!Permission=1!i, "edit (edit) by non permitted user (create blog)" );
...
subtest 'action = refresh_blog_templates' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: refresh_blog_templates" );
    ok( $out !~ m!not implemented!i, "refresh_blog_templates by permitted user" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: refresh_blog_templates" );
    ok( $out !~ m!not implemented!i, "refresh_blog_templates by permitted user (system)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: refresh_blog_templates" );
    ok( $out =~ m!not implemented!i, "refresh_blog_templates by other permission" );
};
...
subtest 'action = clone_blog' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: clone_blog" );
    ok( $out !~ m!not implemented!i, "clone_blog by permitted user(request)" );
    ok( $out !~ m!permission=1!i, "clone_blog by permitted user(permission)" );
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: clone_blog" );
    ok( $out =~ m!permission=1!i, "clone_blog by non permitted user(permission)" );
};
...
subtest 'mode = delete' => sub {
    ...
    $out = delete $app->{__test_output};
    ok( $out, "Request: delete" );
    ok( $out =~ m!permission=1!i, "delete by non permitted user (create blog)" );
